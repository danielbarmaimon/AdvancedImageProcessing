% This function generates a Binomial Markov Randon Fields
% Input:
%		image size as an array (ex [32 32]);
%		Betas: The 3 parameters of the binomial field
% Examples:
%		generate_MRF_Binomial([64 64],[-7.8 3.9 3.9])
%       generate_MRF_Binomial([128 128],[-1 -0.9 -1.9]);
%
...
% Checks every pixel in the image in turn and calculates its
% associated energy Nt for a new grey level value based on its
% neighbours and the associated probability. Accept the change based on this 
% probability by drawing a random number
